        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-slate-400 text-sm">Registro histórico de todas as alterações realizadas na base de dados.</p>
                </div>
                ...
                <CardContent>
                    <Table>
                        <TableHeader className="border-slate-800">
                            <TableRow className="hover:bg-transparent border-slate-800 text-slate-400 text-xs uppercase tracking-wider font-bold">
                            ...
                            {loading ? (
                                <TableRow>
                                    <TableCell colSpan={5} className="text-center py-20">
                                        ...
                                        <p className="mt-2 text-slate-500">Carregando rastros...</p>
                                    </TableCell>
                                </TableRow>
                                ...
                                <TableRow key={log.id} className="border-slate-800 hover:bg-slate-800/30">
                                    ...
                                    <TableCell>
                                        <Badge variant="outline" className="text-[10px] font-bold uppercase border-slate-800 bg-slate-950 text-slate-400">
                                            <Database className="w-3 h-3 mr-1" />
                                            {log.table_name}
                                        </Badge>
                                    </TableCell>
                                    <TableCell>
                                        <Badge className={`text-[10px] font-black uppercase tracking-tighter ${log.action === 'INSERT' ? 'bg-green-900/20 text-green-400 border-green-900/50' :
                                    ...
                                    <TableCell className="max-w-xs truncate text-[11px] text-slate-500">
                                        ...
                                        {log.action === 'DELETE' && 'Registro removido permanentemente'}
                                    </TableCell>
                                </TableRow>
                            ))}
                        </TableBody>
